...
package com.augray.visionx.cropper;
...
public class CropImageView extends FrameLayout {
  ...
  public CropImageView(Context context, AttributeSet attrs) {
    ...
    if (intent != null) {
      Bundle bundle = intent.getBundleExtra(com.theartofdev.edmodo.cropper.CropImage.CROP_IMAGE_EXTRA_BUNDLE);
      if (bundle != null) {
      ...
      if (attrs != null) {
        ...
        try {
          options.fixAspectRatio =
              ta.getBoolean(com.theartofdev.edmodo.cropper.R.styleable.CropImageView_cropFixAspectRatio, options.fixAspectRatio);
          options.aspectRatioX =
              ta.getInteger(com.theartofdev.edmodo.cropper.R.styleable.CropImageView_cropAspectRatioX, options.aspectRatioX);
          options.aspectRatioY =
              ta.getInteger(com.theartofdev.edmodo.cropper.R.styleable.CropImageView_cropAspectRatioY, options.aspectRatioY);
          options.scaleType =
              ScaleType.values()[
                  ta.getInt(com.theartofdev.edmodo.cropper.R.styleable.CropImageView_cropScaleType, options.scaleType.ordinal())];
          options.autoZoomEnabled =
              ta.getBoolean(com.theartofdev.edmodo.cropper.R.styleable.CropImageView_cropAutoZoomEnabled, options.autoZoomEnabled);
          options.multiTouchEnabled =
              ta.getBoolean(
                  com.theartofdev.edmodo.cropper.R.styleable.CropImageView_cropMultiTouchEnabled, options.multiTouchEnabled);
