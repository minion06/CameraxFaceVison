...
class Cameravx(
    ...
    var isFaceOverlay: Boolean,
    var isBackCameraEnabled: Boolean,
    var isApplyCropping: Boolean = false,
    ...
    data class Builder(
        ...
        var isFaceOverlay: Boolean = false,
        var isBackCameraEnabled: Boolean = true,
        var isApplyCropping: Boolean = false,
         ...
         * @return the current Builder.
         */
        fun setCameraBackEnabled(isBackCameraEnabled: Boolean) =
            apply { this.isBackCameraEnabled = isBackCameraEnabled }
        ...
        /**
         *
         * After Completing Applying Cropping Functionality
         *
         * <p>Throws exception on null or not defined.
         *
         * @param applyCropping Current activity launching Cameravx.
         * @return the current Builder.
         */
        fun setIsApplyingCroppingAction(applyCropping: Boolean) =
            apply { this.isApplyCropping = applyCropping }
        ...
        fun build() = Cameravx(
            activity ?: throw NullPointerException(MISSING_ACTIVITY_REFRENCE),
            isFaceOverlay,
            isBackCameraEnabled,
            isApplyCropping,
            directoryName ?: throw  NullPointerException(DIRECTORY_NAME_REQUIRED),
            fileName ?: throw NullPointerException(FILE_NAME_REQUIRED)
        ).launch()
    }
    ...
    private fun launch() {
        ...
        intent.putExtra(IS_APPLYING_CROPPER, this.isApplyCropping)
